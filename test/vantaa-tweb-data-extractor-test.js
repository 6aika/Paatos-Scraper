...
(function() {
  ...
  describe('Vantaa Tweb data extractor tests', () => {
    ...
    it('Test actions extracting', () => {
      ...
      return expect(Promise.resolve(vantaaDataExtractor.extractOrganizationEventActionContents("55015.000000", "130013", "510975521", moment("2017-03-20T14:00:00.000Z"), "10")))
